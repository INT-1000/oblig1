...
<body>
<div class="innhold">
<form method="post" action="Oppg2-3.php">
<h3>Oppgave 2</h3><br/>
<h4>Hvor mye er klokken?</h4><br/>
<img alt="Storeviseren er på 6 og lilleviseren står mellom 2 og 3" src="Bilder/klhalv3.png"/><br/>
...
if($regsvar)
{
  ...
  {
    print("<div id='svar'>");
    print("Svar er feil. Halv 2 er riktig<br/>"); //Sier hva du svarte og hva som var korrekt
    print("du har $poeng poeng!<br/>"); 
    print("</div>");  
  }
