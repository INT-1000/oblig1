...
var games = [
    ...
    { img: 'img/math.png', color:'#F2F6A3', word: '2468' },         //Her bestemmes bakgrunnsbilde,
    { img: 'img/math.png', color:'#F2F6A3', word: '134579' },       //bakgrunnsfarge,
    { img: 'img/math.png', color:'#F2F6A3', word: '123456789' }     //og tallene til hver oppgave.
];
...
$( function() {
    ...
    function buildGame( x ) {
        ...
        // Oppdaterer bakgrunnsbilde (samme bilde brukes hele tiden)
        ...
        // Her er oppsettet til de stokkede tallene
