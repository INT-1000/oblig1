...
?>
<form method="post" action="p2-3.php"> 
	Hva er 8+17? <input type="number" id="svar" name="svar" required /> <br/>
...
if($regsvar)
{
	...
	if($svar=="29")									//GIR DEG SVAR PÅ FORRIGE side1.php
	{
	...
	{
		print("$svar er feil. 29 er riktig<br/>");	//Sier hva du svarte og hva som var korrekt
