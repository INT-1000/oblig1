...
?>
<form method="post" action="p2-4.php"> 
	Hva er 4+23? <input type="number" id="svar" name="svar" required /> <br/>
...
if($regsvar)
{
	...
	if($svar=="25")									//GIR DEG SVAR PÅ FORRIGE side1.php
	{
	...
	{
		print("$svar er feil. 25 er riktig<br/>");	//Sier hva du svarte og hva som var korrekt
