...
?>
<form method="post" action="p3-4.php"> 
	Hva er 34-12? <input type="number" id="svar" name="svar" required /> <br/>
...
if($regsvar)
{
	...
	if($svar=="46")									//GIR DEG SVAR PÅ FORRIGE side1.php
	{
	...
	{
		print("$svar er feil. 46 er riktig<br/>");	//Sier hva du svarte og hva som var korrekt
