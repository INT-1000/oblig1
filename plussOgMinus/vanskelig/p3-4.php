...
?>
<form method="post" action="p3-5.php"> 
	Hva er 39-15? <input type="number" id="svar" name="svar" required /> <br/>
...
if($regsvar)
{
	...
	if($svar=="22")									//GIR DEG SVAR PÅ FORRIGE side1.php
	{
	...
	{
		print("$svar er feil. 22 er riktig<br/>");	//Sier hva du svarte og hva som var korrekt
