...
?>
<form method="post" action="p3-6.php"> 
	Hva er 25+15? <input type="number" id="svar" name="svar" required /> <br/>
...
if($regsvar)
{
	...
	if($svar=="24")									//GIR DEG SVAR PÅ FORRIGE side1.php
	{
	...
	{
		print("$svar er feil. 24 er riktig<br/>");	//Sier hva du svarte og hva som var korrekt
