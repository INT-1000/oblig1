...
<body>
<div class="innhold">
<form method="post" action="Oppg2-6.php">
<h3>Oppgave 5</h3><br/>
<h4>Hvor mye er klokken?</h4><br/>
<img alt="Storeviseren er på 6 og lilleviseren står mellom 8 og 9" src="Bilder/klhalv9.png"/><br/>
...
if($regsvar)
{
  ...
  {
    print("<div id='svar'>");
    print("Svar er feil. Halv 6 er riktig<br/>"); //Sier hva du svarte og hva som var korrekt
    print("du har $poeng poeng!<br/>"); 
    print("</div>");  
  }
