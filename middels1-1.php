<form method="post" action="middels1-1.php" id="regsvar" name="regsvar">
<p> 1?2 </p>
...
<?php
	...
	if ($svar=="<")
	{
		...
		print ("<a href='middels1-2.php'>Neste oppgave</a>");
	}
	else
	{
		print("Beklager, $svar er feil. Riktig svar er <.");
		print ("<a href='middels1-2.php.php'>Neste oppgave</a>");
	}
	}
